...
$experience = [
    [
        ...
        'description' => 'Описание работы Frontend-разработчиком'
    ],
    [
        'name' => 'Веб-разработчик / yandex.ru',
        'dateStart' => 'Март 2014',
        'dateEnd' => 'Май 2017',
        'description' => 'Описание работы веб-разработчиком'
    ],
    [
        'name' => 'Графический дизайнер / vk.com',
        'dateStart' => 'Январь 2012',
        'dateEnd' => 'Февраль 2014',
        'description' => 'Описание работы графическим дизайнером'
    ]
];
?>
<!DOCTYPE html>
        ...
        <div class="w3-third">
            <div class="w3-white w3-text-grey w3-card-4">
                <div class="w3-display-container">
                    <img src="https://murkoshka.ru/wp-content/uploads/zhivotnye-koty-kot-koshka-599230.jpg"
                ...
                <?php for($i = 0; $i < count($experience); $i++):?>
                    <div class="w3-container">
                        ...
                        <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience[$i]['dateStart']?> -
                            <?php if ($i == 0) {
                                echo '<span class="w3-tag w3-teal w3-round">'.
                                    $experience[$i]['dateEnd'].'</span>';
                            } else {
                                echo $experience[$i]['dateEnd']; }?>
                        </h6>
